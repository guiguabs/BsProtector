...
# ==========================================
# ROTAS DE SEO PARA O GOOGLE
# ==========================================

@app.route('/robots.txt')
def robots():
    # Busca o arquivo robots.txt na raiz do seu projeto
    return send_from_directory(app.static_folder, 'robots.txt')

@app.route('/sitemap.xml')
def sitemap():
    # Busca o arquivo sitemap.xml na raiz do seu projeto
    return send_from_directory(app.static_folder, 'sitemap.xml')

# ==========================================
# ROTAS DO SITE E DASHBOARD
# ==========================================
